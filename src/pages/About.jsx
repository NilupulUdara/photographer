  ...
  return (
    <div className="grid grid-cols-2 gap-2 justify-items-stretch py-16 px-8 font-robotoslab">
      <div>
        ...
        context.
        <p className="py-4 font-greyQo text-8xl">Ryan Rodriguez</p>
        <div className="grid grid-cols-4 gap-10 py-8">
          ...
          <div className="flex items-center">
            <svg class="w-8 h-8 text-amber-500 dark:text-white hover:bg-black hover:bg-black hover:scale-90 transition-transform duration-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center">
            <svg class="w-8 h-8 text-amber-500 dark:text-white hover:bg-black hover:scale-90 transition-transform duration-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div>
        <img className="h-auto max-w-full rounded-lg" src={photographer4} alt="" />
      </div>
    </div>
  )
}
